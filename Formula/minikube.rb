class Minikube < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/einyx/minikube-remote/releases/download/v1.36.0-remote/minikube-darwin-arm64"
      ...
      url "https://github.com/einyx/minikube-remote/releases/download/v1.36.0-remote/minikube-darwin-amd64"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/einyx/minikube-remote/releases/download/v1.36.0-remote/minikube-linux-arm64"
      ...
      url "https://github.com/einyx/minikube-remote/releases/download/v1.36.0-remote/minikube-linux-amd64"
