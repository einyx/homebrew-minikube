class Minikube < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/einyx/homebrew-minikube/releases/download/v1.36.0-ssh/minikube-darwin-arm64"
      ...
      url "https://github.com/einyx/homebrew-minikube/releases/download/v1.36.0-ssh/minikube-darwin-amd64"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/einyx/homebrew-minikube/releases/download/v1.36.0-ssh/minikube-linux-arm64"
      ...
      url "https://github.com/einyx/homebrew-minikube/releases/download/v1.36.0-ssh/minikube-linux-amd64"
